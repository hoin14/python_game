...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("/Users/hoins/PycharmProjects/pythonGame/pygame_basic/character.png")
...
# 적 캐릭터
enemy = pygame.image.load("/Users/hoins/PycharmProjects/pythonGame/pygame_basic/character.png")
...
while running:
    ...
    for event in pygame.event.get():  # 이벤트 발생
        if event.type == pygame.QUIT:  # 창이 닫히는 이벤트ㄴ
            running = False
    ...
    # 출력할 글자, True, 글자 색상
    time = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255))
